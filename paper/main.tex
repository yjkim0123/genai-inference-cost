...
\author{\uppercase{Yongjun Kim}\authorrefmark{1} and \uppercase{Eun Jung Sun}\authorrefmark{2} (Corresponding Author)}
\address[1]{Department of Software, Ajou University, Suwon 16499, Republic of Korea (e-mail: yjkim0123@ajou.ac.kr; ORCID: 0000-0003-4234-4883)}
\address[2]{Department of Accounting, Hannam University, Daejeon 34430, Republic of Korea (e-mail: belle@hnu.kr)}

\markboth{IEEE Access}%
{Kim: Predictive Modeling of Generative AI Inference Cost}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/photo_yjkim.jpg}}]{Yongjun Kim}
received the B.B.A. degree from Jeju National University, Republic of Korea, in 2019, the M.S. degree in computer engineering from Hannam University in 2021, and the Ph.D. degree in computer engineering from Jeju National University in 2024. He is currently a Lecturer with the Department of Software, Ajou University, Suwon, Republic of Korea. His research interests include machine learning, energy-efficient AI, and applied data science.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/photo_ejsun.jpg}}]{Eun Jung Sun}
is an Associate Professor with the Department of Accounting, College of Economics and Business Administration, Hannam University, Daejeon, Republic of Korea. Her research interests include financial accounting, corporate governance, ESG, and the application of data analytics to accounting and finance.
\end{IEEEbiography}
